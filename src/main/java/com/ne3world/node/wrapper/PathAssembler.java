...
public class PathAssembler {
    public static final String NODE_USER_HOME_STRING = "NODE_USER_HOME";
    public static final String PROJECT_STRING = "PROJECT";

    private File nodeUserHome;

    public PathAssembler() {
    }

    public PathAssembler(File nodeUserHome) {
        this.nodeUserHome = nodeUserHome;
    }
    ...
    private File getBaseDir(String base) {
        if (base.equals(NODE_USER_HOME_STRING)) {
            return nodeUserHome;
